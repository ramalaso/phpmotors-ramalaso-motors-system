...
function buildInventoryList(data) {
    ...
    let dataTable = '<thead>';
    // datatable += "<div class='form-control'";
    ...
    data.forEach(function (element) {
        ...
        dataTable += `<td>
        <a href='/vehicles?action=mod&id=${element.invId}' title='Click to modify'>
        <span class="material-icons update">
        create </span>
        </a>`;
        dataTable += `<td>
        <a href='/vehicles?action=del&id=${element.invId}' title='Click to delete'><span class="material-icons">
        delete </span></a></td></tr>`;
    });
    dataTable += '</tbody>';
